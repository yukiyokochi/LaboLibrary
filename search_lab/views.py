...
def disclaimer(request):
    return render(request, 'search_lab/disclaimer.html', {})


def privacy_policy(request):
    return render(request, 'search_lab/privacy_policy.html', {})


def terms_of_service(request):
    return render(request, 'search_lab/terms_of_service.html', {})
