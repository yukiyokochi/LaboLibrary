...
class UserCreateApprovalComplete(generic.TemplateView):
    """メール内URLアクセス後のユーザー本登録"""
    template_name = 'accounts/user_create_approval_complete.html'
...
def register_university(request):
    ...
    return render(request, 'accounts/university_create.html', {'form': form})
...
def register_department(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print('ERROR FORM INVALID')
    return render(request, 'accounts/department_create.html', {'form': form})
...
def register_laboratory(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print('ERROR FORM INVALID')
    return render(request, 'accounts/laboratory_create.html', {'form': form})
