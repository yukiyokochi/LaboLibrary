    ...
    if request.user.is_lab_member is True:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return render(request, 'register_lab/register_complete.html', {})
            else:
                print('ERROR FORM INVALID')
        # print(form)
        # print(laboratory)
        return render(request, 'register_lab/register.html', {'form': form, 'laboratory': laboratory})
        # POSTしない場合の画面にformを渡す
    else:
        return render(request, 'register_lab/not_lab_user_error.html', {})


class LabInfoUpdate(UpdateView):
    template_name = 'register_lab/lab_info_update.html'
    ...
    def get_success_url(self):
        return reverse('laboratory_page:lab_page_home')
...
def paper_upload(request):
    if request.user.is_lab_member is True:
        ...
        try:
            ...
            return render(request, 'register_lab/paper_upload_error.html', {})
        # formのインスタンス作成
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return render(request, 'register_lab/paper_upload_complete.html', {})
            else:
                print('ERROR FORM INVALID')
        return render(request, 'register_lab/paper_upload.html', {'form': form})
        # POSTしない場合の画面にformを渡す
    else:
        return render(request, 'register_lab/not_lab_user_error.html', {})
...
class PaperDelete(DeleteView):
    template_name = 'register_lab/paper_delete_confirm.html'
    model = ResearchPaper

    success_url = reverse_lazy('laboratory_page:lab_page_home')
...
def image_upload(request):
    if request.user.is_lab_member is True:
        ...
        try:
            ...
            return render(request, 'register_lab/image_upload_error.html', {})
        # formのインスタンス作成
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return render(request, 'register_lab/image_upload_complete.html', {})
            else:
                print('ERROR FORM INVALID')
        return render(request, 'register_lab/image_upload.html', {'form': form})
        # POSTしない場合の画面にformを渡す
    else:
        return render(request, 'register_lab/not_lab_user_error.html', {})
...
class ImageDelete(DeleteView):
    template_name = 'register_lab/image_delete_confirm.html'
    model = Image
